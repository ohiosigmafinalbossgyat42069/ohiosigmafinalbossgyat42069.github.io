const valanceData = [
  ...
  { "atomic_number": 95, "name": "Americi", "symbol": "Am", "atomic_mass": 243, "valences": ["IV", "V", "VI"] },
  { "atomic_number": 96, "name": "Curi", "symbol": "Cm", "atomic_mass": 247, "valences": ["III"] },
  { "atomic_number": 97, "name": "Berkeli", "symbol": "Bk", "atomic_mass": 247, "valences": ["III", "IV"] },
  { "atomic_number": 98, "name": "Californi", "symbol": "Cf", "atomic_mass": 251, "valences": ["III"] },
  { "atomic_number": 99, "name": "Einsteini", "symbol": "Es", "atomic_mass": 252, "valences": ["III"] },
  { "atomic_number": 100, "name": "Fermi", "symbol": "Fm", "atomic_mass": 257, "valences": ["III"] },
  { "atomic_number": 101, "name": "Mendelevi", "symbol": "Md", "atomic_mass": 258, "valences": ["II", "III"] },
  { "atomic_number": 102, "name": "Nobeli", "symbol": "No", "atomic_mass": 259, "valences": ["II", "III"] },
  { "atomic_number": 103, "name": "Lawrenci", "symbol": "Lr", "atomic_mass": 262, "valences": ["III"] },
  { "atomic_number": 104, "name": "Rutherfordi", "symbol": "Rf", "atomic_mass": 267, "valences": ["IV"] },
  { "atomic_number": 105, "name": "Dubni", "symbol": "Db", "atomic_mass": 268, "valences": ["V"] },
  { "atomic_number": 106, "name": "Seaborgi", "symbol": "Sg", "atomic_mass": 269, "valences": ["VI"] },
  { "atomic_number": 107, "name": "Bohri", "symbol": "Bh", "atomic_mass": 270, "valences": ["VII"] },
  { "atomic_number": 108, "name": "Hassi", "symbol": "Hs", "atomic_mass": 269, "valences": ["VIII"] },
  { "atomic_number": 109, "name": "Meitneri", "symbol": "Mt", "atomic_mass": 278, "valences": ["II", "III", "IV"] },
  { "atomic_number": 110, "name": "Darmstadti", "symbol": "Ds", "atomic_mass": 281, "valences": ["II", "IV"] },
  { "atomic_number": 111, "name": "Roentgeni", "symbol": "Rg", "atomic_mass": 282, "valences": ["I"] },
  { "atomic_number": 112, "name": "Copernici", "symbol": "Cn", "atomic_mass": 285, "valences": ["II"] },
  { "atomic_number": 113, "name": "Nihoni", "symbol": "Nh", "atomic_mass": 286, "valences": ["I", "III"] },
  { "atomic_number": 114, "name": "Flerovi", "symbol": "Fl", "atomic_mass": 289, "valences": ["II", "IV"] },
  { "atomic_number": 115, "name": "Moscovi", "symbol": "Mc", "atomic_mass": 290, "valences": ["III", "V"] },
  { "atomic_number": 116, "name": "Livermori", "symbol": "Lv", "atomic_mass": 293, "valences": ["II", "IV", "VII"] },
  { "atomic_number": 117, "name": "Tennessine", "symbol": "Ts", "atomic_mass": 294, "valences": ["I", "III", "V", "VII"] },
  { "atomic_number": 118, "name": "Oganesson", "symbol": "Og", "atomic_mass": 294, "valences": ["II", "IV"] }
];
...
function startQuiz() {
    const countInput = document.getElementById('element-count').value;
    let count = parseInt(countInput);
    
    if (isNaN(count) || count < 1) count = 1;
    if (count > valanceData.length) count = valanceData.length;
...
function nextQuestion() {
    if (elementIndices.length === 0) {
        document.getElementById('step-quiz').innerHTML = `
            <h2>🎉 Quiz Completed!</h2>
            <p>You have gone through all requested elements.</p>
    ...
    document.getElementById('feedback-msg').style.color = "var(--text-color)";
    document.getElementById('answer-input').value = "";
    document.getElementById('answer-input').disabled = false;

    currentRandomIndex = Math.floor(Math.random() * elementIndices.length);
    currentElementIndex = elementIndices[currentRandomIndex];
    
    const element = valanceData[currentElementIndex];
    document.getElementById('question-text').innerText = `What are the valances of ${element.symbol}?`;
...
function handleSubmission() {
    ...
    const userAnswers = inputField.value.trim().split(/\s+/).filter(item => item !== "");
    const isCorrect = JSON.stringify(element.valences) === JSON.stringify(userAnswers);

    if (isCorrect) {
        feedback.innerHTML = "Good girl~";
        feedback.style.color = "var(--success-color)";
        inputField.disabled = true;
        
        elementIndices.splice(currentRandomIndex, 1);
        ...
        if (attempts === 0) {
            ...
            document.getElementById('clue-container').innerHTML = `
                <div class="clue-box">
                    💡 <strong>Clue:</strong> It's the element <strong>${element.name}</strong> and of atomic number <strong>${element.atomic_number}</strong> :3 Now it is?
                </div>
            `;
            inputField.value = "";
            inputField.focus();
        } else {
            feedback.innerHTML = "Bad girl &gt;: ( youre getting punishment &gt;:3";
